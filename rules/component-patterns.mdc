---
description: Apply when creating React components, deciding between Server vs Client Components, or structuring component composition. Covers the "use client" directive decision tree, server/client boundaries, children pattern, and anti-patterns to avoid.
globs:
    - "**/@features/**/*.tsx"
    - "**/@ui/**/*.tsx"
    - "**/components/**/*.tsx"
