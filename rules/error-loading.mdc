---
description: Apply when implementing error boundaries, loading states, Suspense, or not-found handling. Covers error.tsx, loading.tsx, not-found.tsx conventions, skeleton components, streaming patterns, and the error handling flow from apiClient through to UI.
globs:
  - "**/error.tsx"
  - "**/loading.tsx"
  - "**/not-found.tsx"
