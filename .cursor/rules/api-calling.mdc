---
description: Apply when implementing API calls, data fetching, server actions, mutations, or configuring the apiClient. Covers fetch wrapper patterns, Zod validation, error handling with ApiError, TanStack Query integration, and cache revalidation strategies.
globs:
    - "**/actions/**/*.ts"
    - "**/actions/**/*.tsx"
    - "**/api/**/*.ts"
